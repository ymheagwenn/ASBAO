                    ...
                    ?>
                      <script type="text/javascript">
                        Swal.fire(
                          ...
                          window.location = "index.php?page=dashboard&a=admindashboard";
                        });
                      </script>
                    <?php
                  }
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="index.php?page=home&a=adminprofilepicture" method="POST" enctype="multipart/form-data">
                      ...
                      <p class="text-center">
                        ...
                        <a href="index.php?page=dashboard&a=admindashboard" class="btn btn-gradient-light btn-md me-2">Cancel</a>
                      </p>
                    </form>
                  </div>
                </div>
