              ...
              <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                  <li class="breadcrumb-item" aria-current="page" style="font-weight: normal;">
                    <a href="index.php?page=forms&a=adminformsadd" style="text-decoration: none; padding: 8px;" class="btn-dark text-white">
                    ...
                    <table class="table table-striped" style="width:100%">
                      <thead>
                        <tr>
                          ...
                          <th width="20%" class="text-center"> Files </th>
                      ...
                      <tbody>
                        <?php
                          $count = 1;
                          $sql = mysqli_query($conn,"SELECT * FROM tbl_forms ORDER BY ID ASC LIMIT 100");
                                ...
                                <td class="text-center">
                                  <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                      <a class="dropdown-item" href="index.php?page=forms&a=adminformsedit&id=<?php echo $info['ID']; ?>">Edit</a>
                                      <div class="dropdown-divider"></div>
                                      <form action="admin/admindelete.php" method="POST" onsubmit="return confirm('Delete this form?');">
                                        <input type="hidden" name="deleteformid" value="<?php echo $info['ID']; ?>">
