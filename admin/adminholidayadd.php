              ...
              <?php
                if (isset($_POST['hdate'])){
                    ...
                    if (empty(trim($_POST['hdate']))) {
                      ...
                      $holidaycode = date('ymd-His') . "-". intval( "0" . rand(1,9) . rand(0,9) . rand(0,9) . rand(0,9) . rand(0,9) );
                      $holidaydate = str_replace("'", "", trim($_POST['hdate']));
                      $remarks = str_replace("'", "", trim($_POST['remarks']));
                      $status = "Active";


                      $sql = mysqli_query($conn, "SELECT * FROM tbl_holiday WHERE HOLIDAYDATE = '$holidaydate' AND REMARKS = '$remarks'");
                      if (mysqli_num_rows($sql) > 0){
                          ...
                          $sql = "INSERT INTO tbl_holiday(HOLIDAYCODE, HOLIDAYDATE, REMARKS, STATUS) VALUES('$holidaycode','$holidaydate','$remarks','$status')";
              ...
              <div class="col-8 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="index.php?page=holiday&a=adminholidayadd" method="POST">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="date" class="form-control" id="datepicker" name="hdate" value="<?php if (isset($_POST['hdate'])){ echo $_POST['hdate']; } ?>" />
