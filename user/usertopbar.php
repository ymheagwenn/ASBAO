      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row" style="background-color: #40826D;">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-stretch">
          ...
          <ul class="navbar-nav navbar-nav-left">
            <li class="nav-item nav-settings d-none d-lg-block text-black">
              <?php
                if (isset($_SESSION['USERCODE']) && isset($_SESSION['FIRSTNAME']) && isset($_SESSION['LASTNAME']) && isset($_SESSION['ROLE'])) {
                  echo "<b style='color: #FFFFFF;'>Auxiliary Services and Business Affairs Office Venue Reservation</b>";
                }
              ?>
            </li>
          </ul>
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item nav-profile dropdown">
              ...
              <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                <a class="dropdown-item" href="index.php?page=home&a=usereditprofile">
                  <i class="mdi mdi-account-edit me-2 text-success"></i> Edit Profile
                </a>
                <a class="dropdown-item" href="index.php?page=home&a=userprofilepicture">
                  <i class="mdi mdi-account-box me-2 text-success"></i> Edit Picture
                </a>
                <a class="dropdown-item" href="index.php?page=home&a=userchangepass">
                  <i class="mdi mdi-lock-outline me-2 text-success"></i> Change Password
                </a>
