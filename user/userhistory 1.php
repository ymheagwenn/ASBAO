                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <?php
                            ...
                            $sql = mysqli_query($conn,"SELECT * FROM tbl_appointment INNER JOIN tbl_venuelists ON tbl_appointment.CONTROLCODE = tbl_venuelists.CONTROLCODE WHERE tbl_venuelists.USERCODE = '$usercode' GROUP BY tbl_appointment.CONTROLCODE ORDER BY tbl_appointment.ID ASC LIMIT 50");
                              ...
                              <tr>
                                <td colspan="6">
                                  ...
                                  <div class="col-12 text-center">
                                    <p class="text-dark" style='font-size: 15px;'>There was no appointment history!</p>
                                  </div>
                                  <br><br><br>
                                </td>
                              </tr>
